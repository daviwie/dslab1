...
public class Shell implements Runnable, Closeable {
	 ...
	 *
	 * @return A String containing the contents of the line, not including any line-termination characters, or {@code null} if the end of
	 ...
	 * Note that {@link System#in} and {@link System#out} are not closed. They have to be closed manually since closing them may affect
	 * other objects.
	 */
	@Override
	public void close() {
	 ...
	 * <p/>
	 * <b>Note that this method provided direct access to the {@code Shell} internals.<br/>
	 ...
	 * If the number of formal parameters required by the underlying method is {@code 0}, the supplied {@code args} array may be of length
	 * {@code 0} or {@code null}.
	 * <p/>
	 * If the method is an instance method, it is invoked using dynamic method lookup as documented in <i>The Java Language Specification,
	 * Second Edition</i>, section 15.12.4.4; in particular, overriding based on the runtime type of the target object will occur.
	 * <p/>
	 * If the method completes normally, the value it returns is returned to the caller. If the method return type is {@code void}, the
	 * invocation returns {@code null}.
	 *
