...
/**
 * Please note that this class is not needed for Lab 1, but will later be used in Lab 2. Hence, you do not have to implement it for the
 * first submission.
 */
public class AdminConsole implements IAdminConsole, Runnable {
	...
	/**
	 * @param args the first argument is the name of the {@link AdminConsole} component
	 */
